...
df = pd.read_csv(r'D:\Studium\Master\Masterarbeit\Datensets_Spiegel\Spiegel_s\spiegel_sample\NGrams\spiegel_mini_trigram_nostop.csv')
...
#Funktion des deutschen Snowball Stemmers
def stemm(tokens):
...
#Anwendung des deutschen Snowball Stemmers
tokenized_messages = tokenized_messages.apply(stemm)
